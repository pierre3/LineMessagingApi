...
Task<UserProfile> GetGroupMemberProfile(string groupId, string userId)
Task<UserProfile> GetRoomMemberProfile(string roomId, string userId)
Task<GroupMemberIds> GetGroupMemberIds(string groupId, string continuationToken = null)
Task<GroupMemberIds> GetRoomMemberIds(string roomId, string continuationToken = null)
